...
export default {
  ...
  methods: {
    ...
    checkAddAll(checked) {
      this.addAllCheck =
        this.generatorVO.addCheck.length == this.columnNameList.length;
    ...
    checkUpdateAll(checked) {
      this.updateAllCheck =
        this.generatorVO.updateCheck.length == this.columnNameList.length;
    ...
    checkDetailAll(checked) {
      this.detailAllCheck =
        this.generatorVO.detailCheck.length == this.columnNameList.length;
    ...
    checkListAll(checked) {
      this.listAllCheck =
        this.generatorVO.listCheck.length == this.columnNameList.length;
      this.listIndeterminate =
        !this.listAllCheck && this.generatorVO.listCheck.length > 0;
    },
    copy(id) {
      if (
        this.generatorVO.databaseName == "" ||
        this.generatorVO.tableName == ""
      ) {
